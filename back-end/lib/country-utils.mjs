...
/** ISO 3166-1 alpha-2 codes for name → code lookup */
...
function getCountryNameToCode() {
  ...
  for (const code of ISO_COUNTRY_CODES) {
    try {
      ...
      // skip invalid codes for this runtime
    }
  }
...
/**
 * Normalize a GA country row — always prefer GA's `country` dimension for the label.
 * `countryId` is used for flags when it is a valid ISO code; otherwise derive from name.
 */
