...
I documented each and every one of them step by step [on my blog](/blog/) and on YouTube, going from how I found the idea, how I validated it, the coding process, and publishing it live.
...
- **254** uninstalls - **[YouTube Filter Pro](/blog/youtube-filter-chrome-extension-coding)** has the highest churn at ~43%; **[Claude Limit Monitor](/blog/coding-to-100k-claude-limit-monitor)** retains best at ~73%
- **[Claude Limit Monitor](/blog/coding-to-100k-claude-limit-monitor)** and **[YouTube Filter Pro](/blog/youtube-filter-chrome-extension-coding)** each account for **47%** of all installs and **65%** of active users
...
- My fastest growing extension ([Claude Limit Monitor](/blog/coding-to-100k-claude-limit-monitor)) is open source, and that is probably why it's growing so fast.
...
- Always add a "thank you" and "uninstall" page that lead back to your landing page, on extension install and uninstall, respectively. For the thank you page, add a short tutorial teaching the user how to use your extension. For the uninstall page, add a way to collect feedback on why they uninstalled. Make it super quick and simple. I later wrote about how I [optimized that uninstall page](/blog/chrome-extension-uninstall-page-optimization) and jumped from ~3% to ~34% feedback rate.
